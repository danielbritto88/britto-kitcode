...
| File | When to Read |
|---|---|
| `SKILL.md` | Always — Socratic Gate, progress reporting, communication protocol |
| `dynamic-questioning.md` | When generating domain-specific questions (non-trivial requests) |
