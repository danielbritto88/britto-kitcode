...
This section contains **6 rules** focused on eliminating waterfalls, now including Next.js 15+ `after()` and `connection()` patterns.
...
Next.js 15+ introduced APIs to prevent "Blocking the Main Thread" and ensure "Dynamic Runtime" awareness.
