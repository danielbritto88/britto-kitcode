...
| `9-cache-components.md`                | 🔴 **CRITICAL**    | 4 sections | **Next.js 15+ (canary)**: `use cache`, `cacheLife`, PPR, `cacheTag` |
...
| TypeScript patterns     | `@[skills/clean-code]`            |
