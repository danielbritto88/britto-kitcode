...
- **Priority**: CORE.md rules > intelligent-routing
- If CORE.md specifies explicit routing, follow it
...
Add to CORE.md or CLAUDE.md temporarily:
...
**Next Steps**: Integrate this skill into CORE.md TIER 0 rules.
