...
## Next.js Full-Stack Structure (2026 — Next.js 15 Optimized)
...
| File | Purpose |
|------|---------|
| `proxy.ts` | Next.js 15 Network boundary logic (auth, redirects) |
...
| `src/server/cache-handler.ts` | Next.js 15 Cache Components Manager |
