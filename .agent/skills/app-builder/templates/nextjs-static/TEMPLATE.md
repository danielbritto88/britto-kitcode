---
name: nextjs-static
description: Modern template for Next.js 15, React 19 & Tailwind v4. Optimized for Landing pages and Portfolios.
---
...
|-----------|------------|-------|
| Framework | Next.js 15 | App Router, Turbopack stable, Static Exports |
