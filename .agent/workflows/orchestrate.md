...
| `backend-specialist` | Server | API, Node.js, Bun, Hono, Elysia |
| `database-architect` | Data | SQL, NoSQL, Drizzle, Prisma |
| `security-auditor` | Security | Vulnerabilities, Auth, STRIDE |
| `penetration-tester` | Security | Active testing, exploitation chains |
| `test-engineer` | Testing | Unit, E2E, Coverage, Bun test |
| `devops-engineer` | Ops | CI/CD, Docker, Deploy |
| `mobile-developer` | Mobile | React Native, Flutter, Expo SDK 53 |
| `performance-optimizer` | Speed | Lighthouse, Profiling, Core Web Vitals |
| `seo-specialist` | SEO | Meta, Schema, Rankings, GEO |
| `documentation-writer` | Docs | README, API docs, llms.txt |
| `debugger` | Debug | Error analysis, memory leaks |
| `game-developer` | Games | Unity 6, Godot 4.x |
| `orchestrator` | Meta | Coordination |
| `ai-engineer` | AI/LLM | RAG, MCP servers, embeddings |
| `product-manager` | Requirements | User stories, PRDs, Definition of Ready |
| `product-owner` | Strategy | Backlog, RICE scoring, MVP |
| `qa-automation-engineer` | QA | Playwright, E2E, cross-browser, a11y |
| `code-archaeologist` | Legacy | Refactor, tech debt, TypeScript migration |
...
| Use `/orchestrate` when... | Don't use it when... |
|---|---|
| Task spans multiple domains | Single-domain task |
| Need parallel agent execution | Simple feature request |
| Complex feature needing security + backend + frontend | One file change |
