...
| Use `/ui-ux-pro-max` when... | Don't use it when... |
|---|---|
| Designing a new UI from scratch | Fixing a backend bug |
| Need a distinctive, non-generic design | Making a minor UI tweak |
| Choosing color palette or typography | Implementing a defined mockup exactly |
